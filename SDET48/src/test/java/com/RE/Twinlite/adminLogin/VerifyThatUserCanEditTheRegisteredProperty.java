...
public class VerifyThatUserCanEditTheRegisteredProperty {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//h2[.='Register Room']/../form//input[@name='mobile']")).sendKeys("8881111323");
		driver.findElement(By.xpath("//h2[.='Register Room']/../form//input[@name='alternat_mobile']")).sendKeys("3884411116");
		driver.findElement(By.xpath("//h2[.='Register Room']/../form//input[@name='email']")).sendKeys("ramuUncle2027@yahoo.com");
		...
		driver.findElement(By.xpath("//p[contains(.,'8881111323')]/../../..//a")).click();
		Thread.sleep(2000);
		WebElement options2 = driver.findElement(By.xpath("//select[@id='vacant']"));
		Select s1=new Select(options2);
		s1.selectByValue("1");
		
		driver.findElement(By.xpath("//h2[.='Register Room']/../form//input[@name='other']")).sendKeys("occupied by ramu");
		driver.findElement(By.xpath("//h2[.='Register Room']/../form//button[.='Submit']")).click();
	...
	for(WebElement phone:allPhones) {
		...
		if(phoneNo.contains("8881111323")) {
