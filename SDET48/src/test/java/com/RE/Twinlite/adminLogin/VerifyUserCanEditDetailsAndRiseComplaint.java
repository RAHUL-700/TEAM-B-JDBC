...
public class VerifyUserCanEditDetailsAndRiseComplaint {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//h2[.='Register Room']/../form//input[@name='mobile']")).sendKeys("8884411323");
		driver.findElement(By.xpath("//h2[.='Register Room']/../form//input[@name='alternat_mobile']")).sendKeys("3324400006");
		driver.findElement(By.xpath("//h2[.='Register Room']/../form//input[@name='email']")).sendKeys("ramuUncle2022@yahoo.com");
